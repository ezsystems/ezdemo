...
<div class="content-view-full">
    ...
    {if $node.object.can_create}
        ...
        <form method="post" action={"content/action/"|ezurl}>
            ...
            {if $notification_access }
                <input class="button forum-keep-me-updated" type="submit" name="ActionAddToNotification" value="{'Keep me updated'|i18n( 'design/ezdemo/full/forum' )}" />
            {/if}
    ...
    {else}
        <p>
        {"You need to be logged in to get access to the forums. You can do so %login_link_start%here%login_link_end%"|i18n( "design/ezdemo/full/forum",,
    ...
    <div class="content-view-children">
        ...
        <tr>
            <th class="topic">
                {"Topic"|i18n( "design/ezdemo/full/forum" )}
            </th>
            <th class="replies">
                {"Replies"|i18n( "design/ezdemo/full/forum" )}
            </th>
            <th class="author">
                {"Author"|i18n( "design/ezdemo/full/forum" )}
            </th>
            <th class="lastreply">
                {"Last reply"|i18n( "design/ezdemo/full/forum" )}
            </th>
        </tr>
            ...
            <tr class="{$topic.sequence}">
                <td class="topic">
                    ...
                    {section show=$topic_reply_count|gt( sub( 20, 1 ) )}
                        <p>
                        {'Pages'|i18n( 'design/ezdemo/full/forum' )}:
