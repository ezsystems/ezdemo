...
<div class="content-edit">
    <div class="class-forum-topic">
        ...
        <div class="attribute-header">
            <h1 class="long">{"Edit %1 - %2"|i18n("design/ezdemo/edit/forum_topic",,array($class.name|wash,$object.name|wash))}</h1>
        </div>
        ...
        <div class="buttonblock">
            <input class="defaultbutton" type="submit" name="PublishButton" value="{'Send for publishing'|i18n('design/ezdemo/edit/forum_topic')}" />
            <input class="button" type="submit" name="DiscardButton" value="{'Discard'|i18n('design/ezdemo/edit/forum_topic')}" />
