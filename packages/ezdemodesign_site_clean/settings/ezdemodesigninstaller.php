...
//
class ezdemodesignInstaller extends eZSiteInstaller
{
    const MAJOR_VERSION = 2.0;
    const MINOR_VERSION = 0;

    function ezdemodesignInstaller( $parameters = false )
    {
    ...
    {
        $impl = & $GLOBALS["ezdemodesignInstallerGlobalInstance"];
        if ( get_class( $impl ) != "ezdemodesignInstaller" )
            $impl = new ezdemodesignInstaller( $params );
        return $impl;
    }

    function resetGlobals()
    {
        unset( $GLOBALS["ezdemodesignInstallerGlobalInstance"] );
    }
    ...
    function initSettings( $parameters )
    {
        ...
        // usual user siteaccess like 'ezdemodesign_site'
        $this->addSetting( 'user_siteaccess', eZSiteInstaller::getParam( $parameters, 'user_siteaccess', '' ) );
        // usual admin siteaccess like 'ezdemodesign_site_admin'
                    ...
                    'site.ini' => array(
                        'DesignSettings' => array( 
                            'AdditionalSiteDesignList' => array(
                                'ezdemodesign', 'ezflow', 'base', 'standard'
                                ),
                            'SiteDesign' => 'iphone'
                            ),
                        ) 
