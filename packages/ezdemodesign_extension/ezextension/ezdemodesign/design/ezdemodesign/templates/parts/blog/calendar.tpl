...
<div class="month">
<div class="previous">
<p><a href={$url_back|ezurl} title="{'Previous month'|i18n('design/ezdemodesign/blog/calendar')}">&#8249;&#8249;<span class="hide"> {'Previous month'|i18n('design/ezdemodesign/blog/calendar')}</span></a></p>
</div>
<div class="next">
<p><a href={$url_forward|ezurl} title="{'Next month'|i18n('design/ezdemodesign/blog/calendar')}"><span class="hide">{'Next month'|i18n('design/ezdemodesign/blog/calendar')} </span>&#8250;&#8250;</a></p>
</div>
...
<tr class="top">
    ...
    <th>{"Wed"|i18n("design/ezdemodesign/blog/calendar")}</th>
    <th>{"Thu"|i18n("design/ezdemodesign/blog/calendar")}</th>
    <th>{"Fri"|i18n("design/ezdemodesign/blog/calendar")}</th>
    <th>{"Sat"|i18n("design/ezdemodesign/blog/calendar")}</th>
    <th class="right">{"Sun"|i18n("design/ezdemodesign/blog/calendar")}</th>
</tr>
