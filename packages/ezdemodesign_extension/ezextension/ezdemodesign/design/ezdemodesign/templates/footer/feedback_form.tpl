<h3>{'Get in touch'|i18n('design/ezdemodesign/footer/feedback_form')}</h3>
<form method="post" action={"content/action"|ezurl} class="contact-form">
    <fieldset>
        ...
        <div class="actions">
            <button type="submit" class="btn btn-mini btn-warning pull-right" name="ActionCollectInformation">{'Send'|i18n('design/ezdemodesign/footer/feedback_form')}</button>
