...
<div class="attribute-header">
    <h1 class="long">{"Basket"|i18n("design/ezdemodesign/shop/basket")}</h1>
</div>
{section show=$removed_items}
<div class="warning">
    <h2>{"The following items were removed from your basket because the products were changed."|i18n("design/ezdemodesign/shop/basket",,)}</h2>
    <ul>
...
<h2>{'VAT is unknown'|i18n( 'design/ezdemodesign/shop/basket' )}</h2>
{'VAT percentage is not yet known for some of the items being purchased.'|i18n( 'design/ezdemodesign/shop/basket' )}<br/>
{'This probably means that some information about you is not yet available and will be obtained during checkout.'|i18n( 'design/ezdemodesign/shop/basket' )}
</div>
{/if}
...
<h2>{"Attempted to add object without price to basket."|i18n("design/ezdemodesign/shop/basket",,)}</h2>
{/section}
</div>
{/section}
...
<h2>{"Your payment was aborted."|i18n("design/ezdemodesign/shop/basket",,)}</h2>
{/section}
</div>
{/section}
...
<tr>
    <th>
    {"Count"|i18n("design/ezdemodesign/shop/basket")}
    </th>
    <th>
    {"VAT"|i18n("design/ezdemodesign/shop/basket")}
    </th>
    <th>
    {"Price inc. VAT"|i18n("design/ezdemodesign/shop/basket")}
    </th>
    <th>
    {"Discount"|i18n("design/ezdemodesign/shop/basket")}
    </th>
    <th>
    {"Total price ex. VAT"|i18n("design/ezdemodesign/shop/basket")}
    </th>
    <th>
    {"Total price inc. VAT"|i18n("design/ezdemodesign/shop/basket")}
    </th>
    <th>&nbsp;
    </th>
</tr>
...
<tr class="bgdark">
    ...
    {else}
        {'Unknown'|i18n( 'design/ezdemodesign/shop/basket' )}
    {/if}
    </td>
    <td>
...
<tr class="bglight">
    <td colspan="6"><input class="button" type="submit" name="StoreChangesButton" value="{'Update'|i18n('design/ezdemodesign/shop/basket')}" /></td>
    <td colspan="1"><input class="button" type="submit" name="RemoveProductItemButton" value="{'Remove'|i18n('design/ezdemodesign/shop/basket')}" /> </td>
</tr>
...
<tr>
<td colspan="3">
{"Selected options"|i18n("design/ezdemodesign/shop/basket")}
</td>
</tr>
...
<tr>
     ...
     <td>
     <strong>{"Subtotal ex. VAT"|i18n("design/ezdemodesign/shop/basket")}</strong>:
     </td>
     <td>
     <strong>{"Subtotal inc. VAT"|i18n("design/ezdemodesign/shop/basket")}</strong>:
     </td>
</tr>
<tr>
    <td colspan="5">
...
<tr>
     <td colspan="5">
     <a href={$shipping_info.management_link|ezurl}>{'Shipping'|i18n( 'design/ezdemodesign/shop/basket' )}{if $shipping_info.description} ({$shipping_info.description}){/if}</a>:
     </td>
     <td>
...
<tr>
     <td colspan="5">
     <strong>{'Order total'|i18n( 'design/ezdemodesign/shop/basket' )}</strong>:
     </td>
     <td>
...
<input class="button" type="submit" name="ContinueShoppingButton" value="{'Continue shopping'|i18n('design/ezdemodesign/shop/basket')}" />
<input class="button" type="submit" name="CheckoutButton" value="{'Checkout'|i18n('design/ezdemodesign/shop/basket')}" /> &nbsp;
</div>
...
<div class="feedback">
<h2>{"You have no products in your basket."|i18n("design/ezdemodesign/shop/basket")}</h2>
</div>
