...
<div class="attribute-header">
    <h1 class="long">{"Activate account"|i18n("design/ezdemodesign/user/activate")}</h1>
</div>
...
<form action={"/user/login"|ezurl} method="post">
    <input class="button" type="submit" value="{'OK'|i18n( 'design/ezdemodesign/user/activate' )}" />
</form>
</div>
